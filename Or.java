...
public class Or implements BooleanExpression {
    ...
    public String toPrefixString() {
        return String.format("| %s %s", this.leftOp.toPrefixString(), this.rightOp.toPrefixString());
    }

    @Override
    public String toInfixString() {
        return String.format("%s | %s",this.leftOp.toInfixString(),this.rightOp.toInfixString());
    }
